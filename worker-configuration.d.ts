/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2167cb5ad0d2016dcb18e93c55165862)
// Runtime types generated with workerd@1.20260911.1 2026-09-01 
interface __BaseEnv_Env {
	RP_ID: string;
	ORIGIN: string;
	ADMIN_TOKEN: string;
	ADMIN: DurableObjectNamespace<import("./src/worker/index").Admin>;
	WORKSPACE: DurableObjectNamespace<import("./src/worker/index").Workspace>;
	DOCUMENT: DurableObjectNamespace<import("./src/worker/index").Document>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "Admin" | "Workspace" | "Document";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RP_ID" | "ORIGIN" | "ADMIN_TOKEN">> {}
}
